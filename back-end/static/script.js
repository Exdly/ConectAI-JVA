document.addEventListener("DOMContentLoaded", () => {
  ...
  const CFG = {
    // ADAPTADO PARA HÍBRIDO (LOCAL + VERCEL)
    // Usar "" (string vacío) hace que las peticiones sean relativas al origen actual.
    // En Local: http://localhost:5000/api/chat
    // En Vercel: https://tu-app.vercel.app/api/chat
    BACKEND: "", 
    MIN_W: 300,
    MIN_H: 400,
    MAX_W: 800,
